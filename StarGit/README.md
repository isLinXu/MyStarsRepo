...
### [kuangdd / ttskit](https://github.com/kuangdd/ttskit)
...
### [LesterLian / rat-detection](https://github.com/LesterLian/rat-detection)
...
### [v-iashin / CS231n](https://github.com/v-iashin/CS231n)
...
### [albert-espin / knapsack-packing](https://github.com/albert-espin/knapsack-packing)
...
### [Itaay / bnn](https://github.com/Itaay/bnn)
...
An accurate simulation of the biological process of evolution. Each generated organism has their own statistics for survival and reproductive ability. These statistics, along with many other evolut…
...
### [tayoshittu / 3D-Object-Detection](https://github.com/tayoshittu/3D-Object-Detection)
...
### [SanjinKurelic / CaseBasedReasoning](https://github.com/SanjinKurelic/CaseBasedReasoning)
...
### [nicolas-chaulet / torch-points3d](https://github.com/nicolas-chaulet/torch-points3d)
...
### [ppogg / YOLO-Streaming](https://github.com/ppogg/YOLO-Streaming)
...
### [Adyzng / jd-autobuy](https://github.com/Adyzng/jd-autobuy)

Python爬虫，京东自动登录，在线抢购商品

---

### [xiyaowong / spiders](https://github.com/xiyaowong/spiders)
...
### [rulerstorm / referance_of_wangdao](https://github.com/rulerstorm/referance_of_wangdao)

14年6月-8月王道培训笔记整理

---

### [JamesQFreeman / contrastive_learning_in_100_lines](https://github.com/JamesQFreeman/contrastive_learning_in_100_lines)

A simple and intuitive contrastive learning implementation

---

### [JamesQFreeman / CVFPaperHelper](https://github.com/JamesQFreeman/CVFPaperHelper)

Automatically download multiple papers by keywords in CVPR

---

### [liutwv / img-similarity](https://github.com/liutwv/img-similarity)

Calculate the similarity between images. Include using image color histogram, pHash/dHash, ORB

---

### [monisjaved / Image-similarity](https://github.com/monisjaved/Image-similarity)

Different programs for calculating percentage similarity of two images

---

### [adumrewal / SIFTImageSimilarity](https://github.com/adumrewal/SIFTImageSimilarity)

Interactive code for image similarity using SIFT algorithm

---

### [YeYaJi / Image-similarity-separation](https://github.com/YeYaJi/Image-similarity-separation)

图像--高宽分离+相似度分离

---

### [Dev-Bobbie / Color-Similarity-Calculation](https://github.com/Dev-Bobbie/Color-Similarity-Calculation)

【算法】通过图像颜色计算图像的相似度

---

### [Zhenye-Na / image-similarity-using-deep-ranking](https://github.com/Zhenye-Na/image-similarity-using-deep-ranking)

PyTorch implementation of "Learning Fine-grained Image Similarity with Deep Ranking" (arXiv:1404.4661)

---

### [oke-aditya / image_similarity](https://github.com/oke-aditya/image_similarity)
...
### [willard-yuan / cvtk](https://github.com/willard-yuan/cvtk)
...
### [Okery / YOLOv5-PyTorch](https://github.com/Okery/YOLOv5-PyTorch)

A PyTorch implementation of YOLOv5

---

### [iCSToCS / CSBook](https://github.com/iCSToCS/CSBook)
...
### [RookieHong / ImageSearch](https://github.com/RookieHong/ImageSearch)

An image retrieval system based on MXNET : From training to website

---

### [sayakpaul / A-Barebones-Image-Retrieval-System](https://github.com/sayakpaul/A-Barebones-Image-Retrieval-System)
...
### [peteflorence / MachineLearning6.867](https://github.com/peteflorence/MachineLearning6.867)

My own notes, implementations, and musings for MIT's graduate course in machine learning, 6.867

---

### [ZeweiChu / PyTorch-Course](https://github.com/ZeweiChu/PyTorch-Course)

JULYEDU PyTorch Course

---

### [xiaotudui / pytorch-tutorial](https://github.com/xiaotudui/pytorch-tutorial)
...
### [KaleW515 / image-process](https://github.com/KaleW515/image-process)

图像处理，加噪去噪，滤波，均衡化

---

### [apachecn / imgyaso](https://github.com/apachecn/imgyaso)

提供多种图像处理工具，包括自适应二值化，灰度网格仿色，扩散仿色，和颜色缩减。

---

### [rxy007 / python_code](https://github.com/rxy007/python_code)

python 图像处理 以图搜图 无损压缩

---

### [qcymkxyc / Image-Process](https://github.com/qcymkxyc/Image-Process)

冈萨雷斯《数字图像处理》Python实现(第三版)

---

### [sapicd / sapic](https://github.com/sapicd/sapic)

sapic(picbed) - 基于Flask的Web自建图床，可存储到又拍云、七牛云、阿里云OSS、腾讯云COS、GitHub、Gitee、S3等，支持自定义扩展。

---

### [kangvcar / kkimage](https://github.com/kangvcar/kkimage)

图像处理，基于Python OpenCV的图像算法研究，包括平移变换、尺度变换、旋转变换、仿射变换、灰度映射（求反、动态范围压缩、阶梯量化、阈值分割）、图像的算术运算（加法、平均法消除噪声、减法）、直方图修正（直方图均衡化、直方图规定化）、空域滤波（线性平滑滤波器、线性锐化滤波器、非线性平滑滤波器、非线性锐化滤波器）、傅里叶变换和反变换、高通和低通滤波器（分别考虑:理想滤波器、巴特沃斯滤波器…
...
### [Didnelpsun / CS408](https://github.com/Didnelpsun/CS408)

考研计算机科学408笔记整理

---

### [miraclesc / Online-Exam-of-XMU](https://github.com/miraclesc/Online-Exam-of-XMU)

厦门大学考研上机真题

---

### [ming71 / mmdetection-annotated](https://github.com/ming71/mmdetection-annotated)
...
### [ruinmessi / RFBNet](https://github.com/ruinmessi/RFBNet)

Receptive Field Block Net for Accurate and Fast Object Detection, ECCV 2018

---

### [lyk19940625 / MyRFBNet](https://github.com/lyk19940625/MyRFBNet)

基于RFBNET实现对无人机航拍图中电力杆塔，输电线的异常检测

---

### [lyk19940625 / WorkControl](https://github.com/lyk19940625/WorkControl)

变电站作业管控平台。包括人脸识别考勤，移动目标跟踪，越线检测，安全措施检测，姿态识别等功能。

---

### [lyk19940625 / VisualizationOfMachineLearning](https://github.com/lyk19940625/VisualizationOfMachineLearning)

使用 Django 框架搭建学习平台，实现KNN、ID3、C4.5、SVM、朴素贝叶斯、BP神经网络等算法及流程管理

---

### [waspinator / pycococreator](https://github.com/waspinator/pycococreator)

Helper functions to create COCO datasets

---

### [dream80 / DeepFaceLab_Linux](https://github.com/dream80/DeepFaceLab_Linux)

Linux环境，自用！阿里云P4测试通过！

---

### [AmazingUU / Douyin_spider](https://github.com/AmazingUU/Douyin_spider)

抖音爬虫

---

### [yijingping / unicrawler](https://github.com/yijingping/unicrawler)

一个可配置的、分布式的爬虫框架

---

### [JoeanAmiee / Spiders](https://github.com/JoeanAmiee/Spiders)
...
### [lonsty / weibo-image-spider](https://github.com/lonsty/weibo-image-spider)
...
### [atomicoo / EnhanceIMG](https://github.com/atomicoo/EnhanceIMG)
...
### [DataXujing / CNN-paper2](https://github.com/DataXujing/CNN-paper2)

深度学习 卷积神经网络教程 ：图像识别，目标检测，语义分割，实例分割，人脸识别，神经风格转换，GAN等 https://dataxujing.github.io/CNN-paper2/

---

### [CompVis / image2video-synthesis-using-cINNs](https://github.com/CompVis/image2video-synthesis-using-cINNs)

Implementation of Stochastic Image-to-Video Synthesis using cINNs.

---

### [KevinJia1212 / yolact_cityscapes_550](https://github.com/KevinJia1212/yolact_cityscapes_550)

Modified real-time instance segmentation network YOLACT for several object categories on CityScapes dataset

---

### [akTwelve / YOLACT-tutorial](https://github.com/akTwelve/YOLACT-tutorial)

A tutorial for using YOLACT in Google Colab

---

### [DataXujing / yolact_pytorch](https://github.com/DataXujing/yolact_pytorch)
...
### [feiyuhuahuo / Yolact_minimal](https://github.com/feiyuhuahuo/Yolact_minimal)

Minimal PyTorch implementation of YOLACT.

---

### [haixiangyan / leetcode-python](https://github.com/haixiangyan/leetcode-python)
...
### [mengcius / Surface-Defect-Detection](https://github.com/mengcius/Surface-Defect-Detection)

Segmentation-Based Deep-Learning Approach for Surface-Defect Detection

---

### [abin24 / Saliency-detection-toolbox](https://github.com/abin24/Saliency-detection-toolbox)

This is a Saliency detection toolbox Specially designed for surface defect detection.

---

### [Tom-Hardy-3D-Vision-Workshop / awesome-defect-detection](https://github.com/Tom-Hardy-3D-Vision-Workshop/awesome-defect-detection)

defect detection algorithm

---

### [LeeWise9 / Segmentation-Based-Surface-Defect-Detection](https://github.com/LeeWise9/Segmentation-Based-Surface-Defect-Detection)
...
### [seanXYZ / SegDecNet](https://github.com/seanXYZ/SegDecNet)

Pytorch Implement of the paper "Segmentation-Based Deep-Learning Approach for Surface Defect Detection"

---

### [skokec / segdec-net-jim2019](https://github.com/skokec/segdec-net-jim2019)

Surface Defect Detection with Segmentation-Decision Network on KolektorSDD

---

### [yangmingwanli / InspectAI](https://github.com/yangmingwanli/InspectAI)

General Purpose Defect Inspection Tool

---

### [sundyCoder / DEye](https://github.com/sundyCoder/DEye)
...
### [ag-piyush / Bone-Fracture-Detection---MURA](https://github.com/ag-piyush/Bone-Fracture-Detection---MURA)

Bone fracture detection using DenseNet on MURA dataset

---

### [LiMeng95 / pytorch_hand_classifier](https://github.com/LiMeng95/pytorch_hand_classifier)
...
### [Skylark0924 / Machine-Learning-is-ALL-You-Need](https://github.com/Skylark0924/Machine-Learning-is-ALL-You-Need)
...
### [Laughing-q / yolov5_annotations](https://github.com/Laughing-q/yolov5_annotations)

---

### [DeepWisdom / AutoDL](https://github.com/DeepWisdom/AutoDL)

Automated Deep Learning without ANY human intervention. 1'st Solution for AutoDL challenge@NeurIPS.

---

### [msnh2012 / CasiaLabeler](https://github.com/msnh2012/CasiaLabeler)
...
### [omnigeeker / mlnd_DeepTesla](https://github.com/omnigeeker/mlnd_DeepTesla)
...
### [MengTianjian / MaskRCNN](https://github.com/MengTianjian/MaskRCNN)
...
算法相关知识储备 LeetCode with Python and JavaScript 
...
### [KSkun / OI-Templates](https://github.com/KSkun/OI-Templates)

My templates used in OI. All C++.

---

### [ECNUdase / Seminar-Materials](https://github.com/ECNUdase/Seminar-Materials)

组会ppt与论文--每一次的精心准备都值得留下记录

---

### [harvestlamb / Cpp_houjie](https://github.com/harvestlamb/Cpp_houjie)

侯捷C++课程PPT及代码,动手学起来

---

### [19PDP / Bilibili-plus](https://github.com/19PDP/Bilibili-plus)

课程视频、PPT和源代码：侯捷C++系列；台大郭彦甫MATLAB

---

### [EugeneLiu / translationCSAPP](https://github.com/EugeneLiu/translationCSAPP)
...
### [R3ab / ttpla_dataset](https://github.com/R3ab/ttpla_dataset)

aerial images dataset on transmission towers and power lines

---

### [CVUsers / Smoke-Detect-by-YoloV5](https://github.com/CVUsers/Smoke-Detect-by-YoloV5)
...
### [LabyrinthineLeo / Yxs_Git_Learning_repos](https://github.com/LabyrinthineLeo/Yxs_Git_Learning_repos)

Yxs's motley collection of code repositories.
...
### [stavrosgreece / Image-Detection-on-TACO](https://github.com/stavrosgreece/Image-Detection-on-TACO)

Training of ResNet50, simple Yolo, and Mask-RCNN models for image classification-segmentation on the TACO dataset

---

### [AmirhosseinFarzadi / K-Means-Clustering-py](https://github.com/AmirhosseinFarzadi/K-Means-Clustering-py)

The k-means clustering method is an unsupervised machine learning technique used to identify clusters of data objects in a dataset. There are many different types of clustering methods, but k-means…

---

### [chumingqian / Making_Dataset-For-Yolov3v4](https://github.com/chumingqian/Making_Dataset-For-Yolov3v4)

COCO, VOC ,dataset , Ultralytics version - yolov3v4

---

### [kaaier / make-dataset-VOC2007-](https://github.com/kaaier/make-dataset-VOC2007-)

制作属于自己的VOC2007数据集

---

### [XCRobert / Labelme2Coco](https://github.com/XCRobert/Labelme2Coco)

Make your own dataset for object detection and transform the format to coco json format

---

### [WangRongsheng / make-your-yolov5_dataset](https://github.com/WangRongsheng/make-your-yolov5_dataset)

Make your yolov5 dataset by using labelimg.I hope my work can help you make your yolov5 datasets more quickly.

---

### [evilsocket / ergo](https://github.com/evilsocket/ergo)

A tool that makes AI easier.

---

### [mdiephuis / image_utilities](https://github.com/mdiephuis/image_utilities)

Collection of basic functions used for image processing and feature detection

---

### [hellock / icrawler](https://github.com/hellock/icrawler)

A multi-thread crawler framework with many builtin image crawlers provided.

---

### [littlebearsama / 3D-ObjectDetection-and-Pose-Estimation](https://github.com/littlebearsama/3D-ObjectDetection-and-Pose-Estimation)

3D目标检测与位姿估计学习笔记

---

### [lesleyping / Machine-Learning](https://github.com/lesleyping/Machine-Learning)
